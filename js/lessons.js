...
export const LESSONS = [
  ...
  // -------- レッスン 2: ダイスの使い方 --------
  {
    ...
    steps: [
      ...
      { type: "narrate", text: "次は『ゾロ目』(同じ目)を体験しましょう。\n同じ目が2つ揃うと、なんと4回動かせる大チャンスです。" },
      { type: "rollFixed", dice: [4, 4], narration: "ゾロ目4が出ました！4回連続で動かせます。" },
      { type: "expectMove", move: { from: 23, to: 19 }, hint: "後方の24ポイント白を20ポイントへ (1/4)" },
      { type: "expectMove", move: { from: 23, to: 19 }, hint: "もう一つの24ポイントも20ポイントへ。20ポイントがメイドに！(2/4)" },
      { type: "expectMove", move: { from: 12, to: 8 }, hint: "13ポイントの白を9ポイントへ (3/4)" },
      { type: "expectMove", move: { from: 12, to: 8 }, hint: "もう一つを9ポイントへ。9ポイントもメイド！(4/4)" },
      { type: "narrate", text: "ゾロ目4で一気に2つのメイドポイントを作れました。\nゾロ目はチャンス、活かしましょう！\n次のレッスンではヒットを学びます。" },
      { type: "endLesson" },
    ],
  },
  ...
  // -------- レッスン 4: ベアオフ --------
  {
    ...
    steps: [
      ...
      { type: "narrate", text: "上がり方は分かりましたね。\n残りの13個も同じ要領で続ければ全て出し切れます。\n次のステップで、AIに代わって最後まで上がる様子を高速で見てみましょう。" },
      { type: "autoBearOff", narration: "AIが代わりに高速で上がっていきます..." },
      { type: "narrate", text: "全15個出し切り完了！これがベアオフの最終形です。\n実戦では先にここまで辿り着いた方が勝者です。" },
      { type: "endLesson" },
    ],
  },
